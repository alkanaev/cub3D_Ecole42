...
{
	//all->sprite_img.relative_path = "./sprite.xpm";
	all->sprite_img.img = mlx_xpm_file_to_image(all->data.mlx, all->sprite_img.spr, &all->sprite_img.img_width, &all->sprite_img.img_height);
...
{
	//all->texture[north].relative_path = "./walls/north_wall.xpm";
	//all->texture[north].relative_path = "./sprite.xpm";
	all->texture[north].img = mlx_xpm_file_to_image(all->data.mlx, all->texture[north].no_path, &all->texture[north].img_width, &all->texture[north].img_height);
...
{
	//all->texture[south].relative_path = "./walls/south_wall.xpm";
	all->texture[south].img = mlx_xpm_file_to_image(all->data.mlx, all->texture[south].so_path, &all->texture[south].img_width, &all->texture[south].img_height);
...
{
	//all->texture[east].relative_path = "./walls/east_wall.xpm";
	all->texture[east].img = mlx_xpm_file_to_image(all->data.mlx, all->texture[east].ea_path, &all->texture[east].img_width, &all->texture[east].img_height);
...
{
	//all->texture[west].relative_path = "./walls/west_wall.xpm";
	all->texture[west].img = mlx_xpm_file_to_image(all->data.mlx, all->texture[west].we_path, &all->texture[west].img_width, &all->texture[west].img_height);
